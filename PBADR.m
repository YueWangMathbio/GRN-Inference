% This code is for the simulation in Subsection 8.6 of the paper 
...
% for the method of combining path blocking with phenotype data and 
...
save papir.dat pir -ascii
save papio.dat pio -ascii
save panir.dat nir -ascii
save panio.dat nio -ascii
% n=1e5
